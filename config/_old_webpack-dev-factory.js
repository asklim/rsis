...
{
    // Это конфигурации только для разработки. Есть два варианта:
    // development - построения билда в папке paths.appBuild и запуска
    // HotModuleReplacement - для разработки с webpack-dev-middleware

    const isHMR = webpackEnv === 'HotModuleReplacement';
    ...
    return {
        ...
        module: {
            ...
            rules: [
            // webpack5 FIXED: unknown property
