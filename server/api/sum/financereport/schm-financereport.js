...
const ItemProfitRecord = new mongoose.Schema({
 ...
 */
const FinanceSummary = new mongoose.Schema({
...
const UsdRates = new mongoose.Schema({
...
**/
const FinanceWeekReportBody = new mongoose.Schema({

    usdRates: { 
        type: mongoose.Mixed, 
        ref:  function() { UsdRates; }, 
    },

    items: {
        type: [ ItemProfitRecord ],
    },
 ...
 * 
**/
const FinanceQuarterReportBody = new mongoose.Schema({
 ...
 * 
**/
const FinanceReport = new mongoose.Schema({
